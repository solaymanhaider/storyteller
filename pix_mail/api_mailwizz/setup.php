...
$config = new MailWizzApi_Config(array(
    'apiUrl'        => Mailwizz_apiUrl,
    'publicKey'     => Mailwizz_publicKey,
    'privateKey'    => Mailwizz_privateKey,

    // components
    'components' => array(
        'cache' => array(
            'class'     => 'MailWizzApi_Cache_File',
            'filesPath' => dirname(__FILE__) . '/Cache/data/cache', // make sure it is writable by webserver
        )
    ),
));
